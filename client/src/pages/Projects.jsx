                ...
                <div className="flex items-center gap-2">
                    <div className="flex bg-slate-100 p-1 rounded-lg">
                        <button
                            ...
                            className={`p-2 rounded-md transition-all ${viewMode === 'grid' ? 'bg-white text-primary shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                        >
                            <LayoutGrid size={20} />
                        </button>
                        <button
                    ...
                    {filteredProjects.map((project, index) => (
                        ...
                        >
                            <Link to={`/app/projects/${project._id}`}>
                                <div className={`bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group ${viewMode === 'list' ? 'flex items-center justify-between gap-6' : ''}`}>
                                    ...
                                    <div className={viewMode === 'list' ? "flex items-center gap-6 flex-1" : "mb-4"}>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-bold text-slate-900 group-hover:text-primary transition-colors mb-1">{project.title}</h3>
                                            <p className="text-slate-500 text-sm flex items-center gap-2">
                                                <span className="px-2 py-0.5 bg-slate-100 rounded text-xs font-medium">{project.category || 'General'}</span>
                                                <span>•</span>
