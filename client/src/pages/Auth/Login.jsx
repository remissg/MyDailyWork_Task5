    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 flex items-center justify-center p-6 font-sans">
            <div className="w-full max-w-md">
                ...
                >
                    {error && (
                        <div className="bg-red-100 border border-red-200 text-red-700 p-3 rounded-xl mb-6 text-sm text-center">
                            {error}
                        </div>
                    )}
                    ...
                    <div className="mt-8 text-center text-sm text-slate-500">
                        <p>Don't have an account? <Link to="/register" className="text-primary hover:text-primary/80 font-bold hover:underline">Sign Up</Link></p>
                    </div>
                </motion.div>
            </div>
        </div>
